...
public class Main extends Application {
	...
	Image image = new Image("StartingPanel1.jpg", 253, 397, false, false);
	BackgroundImage bgi = new BackgroundImage(image, BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT,
			BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
	Background bg = new Background(bgi);

	Image logo = new Image("StartingPanel2.jpg", 275, 70, false, false);
	BackgroundImage ENMImage = new BackgroundImage(logo, BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT,
			BackgroundPosition.CENTER, BackgroundSize.DEFAULT);
	Background ENM = new Background(ENMImage);

	Image image2 = new Image("Retrieval.JPG", 775, 350, false, false);
	...
	public void start(Stage primaryStage) throws Exception {
		...
		usnText.setPromptText("ex: Cis3270");
		...
		usnText1.setPromptText("ex: Cis3270");
		...
		pswText.setPromptText("ex: Programming2021");
		pswText.setPrefSize(300,25);
        password.getStylesheets().add(getClass().getResource("application.css").toExternalForm()); //makes the font change from weird symbols to real text
        pswText.getStylesheets().add(getClass().getResource("application.css").toExternalForm()); //makes the font change from weird symbols to real text
		...
		pswText1.setPromptText("ex: Programming2021");
		...
		fnText.setPromptText("ex: Andrea");
		...
		emText.setPromptText("ex: cis3270@gmail.com");
		...
		addText.setPromptText("ex: 518 Langdale");
		...
		sqText.setPromptText("ex: What is your concentration?");
		...
		saText.setPromptText("ex: Application Development");
		...
		btFgot.setLayoutY(310);
		btFgot.setPrefSize(150,30);
		btRegi.setLayoutX(175);
		btRegi.setLayoutY(270);
		btRegi.setPrefSize(150,30);
		...
		ENMLogo.setBackground(ENM);


		AnchorPane log = new AnchorPane(border,loginLayout, ENMLogo);
		...
		log.setTopAnchor(ENMLogo, 55.0);
		log.setLeftAnchor(ENMLogo, 225.0);
		...
		c1Id.setStyle("-fx-text-fill: Green;");
		c1Id.setLayoutX(150);
		c1Id.setLayoutY(15);
		...
		yourPsw = new Label("Retrieved Password: ");
		yourPsw.setFont(Font.font(STYLESHEET_CASPIAN, FontWeight.BOLD, 14));
		yourPsw.setStyle("-fx-text-fill: Grey;");
		yourPsw.setLayoutX(15);
		yourPsw.setLayoutY(170);
